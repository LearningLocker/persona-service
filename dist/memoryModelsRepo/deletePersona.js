...
exports.default = function (config) {
    return function (opts) { return __awaiter(_this, void 0, void 0, function () {
        var storedPersonas, remainingPersonas;
        return __generator(this, function (_a) {
            storedPersonas = config.state.personas;
            remainingPersonas = storedPersonas.filter(function (persona) {
                return !(persona.id === opts.personaId &&
                    persona.organisation === opts.organisation);
            });
            if (storedPersonas.length === remainingPersonas.length) {
                throw new NoModel_1.default('Persona');
            }
...
//# sourceMappingURL=deletePersona.js.map