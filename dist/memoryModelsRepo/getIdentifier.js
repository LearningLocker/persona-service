...
exports.default = function (config) {
    return function (opts) { return __awaiter(_this, void 0, void 0, function () {
        var matchingIdentifiers, isExistingIdentinnfier, identifier;
        return __generator(this, function (_a) {
            matchingIdentifiers = config.state.personaIdentifiers.filter(function (identifier2) {
                return identifier2.id === opts.id && identifier2.organisation === opts.organisation;
            });
            isExistingIdentinnfier = matchingIdentifiers.length !== 0;
