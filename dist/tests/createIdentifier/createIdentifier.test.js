...
describe('createIdentifier', function () {
    ...
    it('Should create identifier', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    assert.deepEqual(actualIdentifier.ifi, values_1.TEST_IFI);
                    assert.equal(actualIdentifier.organisation, values_1.TEST_ORGANISATION);
                    assert.equal(actualIdentifier.persona, persona.id);
                    return [2 /*return*/];
            }
        });
    }); });
    it('Should update an identidier', function () { return __awaiter(_this, void 0, void 0, function () {
        var persona, wasCreated;
    ...
    it('Should create identifiers in different organisations', function () { return __awaiter(_this, void 0, void 0, function () {
        var persona, wasCreated;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createTestPersona_1.default()];
...
//# sourceMappingURL=createIdentifier.test.js.map