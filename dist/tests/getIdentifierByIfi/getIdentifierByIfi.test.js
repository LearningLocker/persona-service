...
describe('getIdentifierByIfi', function () {
    var service = setup_1.default();
    it('Should get the identifier by ifi', function () { return __awaiter(_this, void 0, void 0, function () {
        var personaId, actualPersonaId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createTestIdentifier_1.default()];
                case 1:
                    personaId = (_a.sent()).personaId;
                    return [4 /*yield*/, service.getIdentifierByIfi({
                            ifi: values_1.TEST_IFI,
                            organisation: values_1.TEST_ORGANISATION,
                        })];
                case 2:
                    actualPersonaId = (_a.sent()).personaId;
                    assert.equal(personaId, actualPersonaId);
                    return [2 /*return*/];
            }
        });
    }); });
    it('Should throw an exception if no model', function () { return __awaiter(_this, void 0, void 0, function () {
        var resultPromise;
        return __generator(this, function (_a) {
            resultPromise = service.getIdentifierByIfi({
                ifi: values_1.TEST_IFI,
                organisation: values_1.TEST_ORGANISATION,
            });
...
//# sourceMappingURL=getIdentifierByIfi.test.js.map