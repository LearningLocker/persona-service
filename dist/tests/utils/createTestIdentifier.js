...
var createTestPersona_1 = require("./createTestPersona");
exports.default = function () { return __awaiter(_this, void 0, void 0, function () {
    var personaId, identifier;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, createTestPersona_1.default()];
            case 1:
                personaId = (_a.sent()).id;
                return [4 /*yield*/, tester_1.default.createIdentifier({
            ...
            case 2:
                ...
                return [2 /*return*/, { identifier: identifier, personaId: personaId }];
        }
    });
}); };
//# sourceMappingURL=createTestIdentifier.js.map