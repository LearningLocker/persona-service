...
describe('getPersona with non-existing model', function () {
    ...
    it('should error getting model outside the org', function () { return __awaiter(_this, void 0, void 0, function () {
        var persona, promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.createPersona({
                        name: 'Dave',
                        organisation: values_1.TEST_ORGANISATION,
                    })];
                case 1:
...
//# sourceMappingURL=getNonExistingPersona.test.js.map