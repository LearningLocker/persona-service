...
var createUpdateIdentifierPersona = function (config) {
    return function (_a) {
        var organisation = _a.organisation, ifi = _a.ifi, personaName = _a.personaName, _b = _a.getIdentifier, getIdentifier = _b === void 0 ? getIdentifier_1.default(config) : _b;
        return __awaiter(_this, void 0, void 0, function () {
