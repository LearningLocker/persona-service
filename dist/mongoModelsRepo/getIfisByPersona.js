...
exports.default = function (config) {
    return function (_a) { return __awaiter(_this, void 0, void 0, function () {
        var organisation = _a.organisation, opts = __rest(_a, ["organisation"]);
        var collection, documents, ifis;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, collection.find({
                            ...
                            persona: new mongodb_1.ObjectID(opts.personaId),
                        }).toArray()];
                case 2:
                    documents = _a.sent();
                    ifis = documents.map(function (document) {
                        return document.ifi;
                    });
                    return [2 /*return*/, { ifis: ifis }];
            }
        });
    }); };
};
//# sourceMappingURL=getIfisByPersona.js.map