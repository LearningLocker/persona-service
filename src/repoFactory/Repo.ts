import type CommonRepo from 'jscommons/dist/repoFactory/Repo';
...
export default interface Repo extends CommonRepo {
  ...
  readonly overwriteIdentifier: (opts: OverwriteIdentifierOptions) => Promise<OverwriteIdentifierResult>;
